    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-5 pt-3 pb-3">
                    <div class="text-center text-dark">
                        <h3>Review From Our Visitors</h3>
                    </div>
                    <div class="text-muted text-center">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="text-light mt-5 mb-2">
                            ...
                            <p>Best Wishes From Our Happy Visitors.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="review-user-cmmnt">
                            <img src="{{asset('/')}}/user-asset/images/founder902_n.jpg" class="stamp-img" alt="stamp">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 pt-3 pb-3">
                    <div class="text-center mt-3">
                        <h1>E-token</h1>
                        <img src="{{asset('/')}}/user-asset/images/api-token.png" class="img-responsive">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 pt-3 pb-3">
                    <div class="text-center mt-3">
                        ...
                        <img src="{{asset('/')}}/user-asset/images/online.jpg" class="img-responsive">
