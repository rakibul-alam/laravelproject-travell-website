...
<head>
    ...
    <title>TourPlan2</title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('/')}}/admin-asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Page level plugin CSS-->
    <link href="{{asset('/')}}/admin-asset/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="url('/')}">TourPlan2</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <i class="fas fa-caret-down fa-fw text-white"></i>
            </a>
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="{{route('create-category')}}">Create</a>
                <a class="dropdown-item" href="{{route('manage-category')}}">Manage</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown2">
                <a class="dropdown-item" href="{{route('create-package')}}">Create</a>
                <a class="dropdown-item" href="{{route('manage-package')}}">Manage</a>
            </div>
        </li>
    </ul>
...
<script src="{{asset('/')}}/admin-asset/vendor/datatables/jquery.dataTables.js"></script>
<script src="{{asset('/')}}/admin-asset/vendor/datatables/dataTables.bootstrap4.js"></script>
